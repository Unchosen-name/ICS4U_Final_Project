...
public class QNAStudent extends QNAPage
{
   ...
   private static void askQ ()               // this method prompts student to ask a question
   {
      String newQuestion;                    // declare a String representing new question
		int category = INITIAL;                // decalre and initialize category number, which will be entered later
		                                       // to better define the new question
      do
      {
         sc.nextLine();
         ...
         newQuestion = sc.nextLine();                                // user enters their question
            ...
            System.out.println ();
				...
				System.out.println ();
            String newCategory = categories.get(category-1);        // the new category is given a String value 
                                                                    //(take the category at position "chosen category number - 1" in array list)
   ...
   {  																 // parametres: newQuestion is the question to be added to array list
