...
public class QNAPage                                                          
{
	...
	protected static final String ANSWERED = "Inactive QNAs.txt";              // file name for all answered questions
   protected static final String CATEGORY = "Category.txt";                   // file name for all categories
